...
class ColorLoader2 extends StatefulWidget {
  ...
  ColorLoader2(
      {this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = AppColor.primaryColor});
...
class _ColorLoader2State extends State<ColorLoader2>
  ...
  void initState() {
    ...
    animation3 = Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
        parent: controller3 as Animation<double>,
      ...
      child: Stack(
        children: <Widget>[
          new RotationTransition(
            turns: animation1 as Animation<double>,
            child: CustomPaint(
          ...
          new RotationTransition(
            turns: animation3 as Animation<double>,
            child: CustomPaint(
